...
def send_negotiation_email(to_email: str, customer_name: str, offers: list[dict]) -> bool:
    ...
    <ul>{offer_lines}</ul>
    <p><a href="http://127.0.0.1:8000/respond?order_id={offers[0]['order_id']}&decision=accept">Accept alternative</a>
       | <a href="http://127.0.0.1:8000/respond?order_id={offers[0]['order_id']}&decision=decline">Decline, refund instead</a></p>
    """
